...
## PROFILE SUMMARY
- Python backend developer experienced in building RESTful APIs with FastAPI and SQLAlchemy, designing database schemas with PostgreSQL, and writing test-driven backend services. Passionate about clean, maintainable code, API reliability patterns, and building scalable server-side applications.

## KEY SKILLS
- Backend & API: Python, FastAPI, REST API design, SQLAlchemy 2.0, Alembic, pytest
- Database: PostgreSQL, SQL, MySQL, SQLAlchemy ORM
- Tools & DevOps: Git, GitHub Actions, Docker, Docker Compose, Linux, Bash
- Cloud & Infrastructure: AWS (EC2, RDS, Lambda), Terraform
